...
export const misconceptions: Misconception[] = [
  ...
  {
    id: "gpl-allows-commercial",
    myth: "The GPL allows commercial use",
    reality:
      "The GPL explicitly permits commercial use. You can sell GPL-licensed software, charge for support, or build a business around it. Companies like Red Hat have built billion-dollar businesses on GPL software. The GPL's requirements are about sharing source code, not about preventing profit.",
    isTrue: true,
  },
  {
    id: "gpl-no-money",
  ...
  {
    id: "apache-patent-grant",
    myth: "Apache 2.0 includes an explicit patent grant",
    reality:
      "Apache License 2.0 includes a clear patent license in Section 3, granting users a royalty-free patent license for any patents held by contributors that cover their contributions. This is one of the key advantages of Apache 2.0 over simpler permissive licenses like MIT or BSD, which do not explicitly address patents.",
    isTrue: true,
  },
  {
  ...
  {
    id: "mit-include-license-text",
    myth: "You must include the MIT license text when redistributing MIT-licensed code",
    reality:
      "The MIT license explicitly states that the copyright notice and permission notice \"shall be included in all copies or substantial portions of the Software.\" This is the single condition of the MIT license. Simply using MIT code without preserving the license text is a violation, even though it's often overlooked.",
    isTrue: true,
  },
  {
    id: "readme-enough",
