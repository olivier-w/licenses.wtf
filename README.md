...
Open source licenses, actually explained.

A beautiful, modern, single-page educational site helping developers understand open source licenses. Compare MIT, Apache, GPL, and more with an interactive spectrum, filterable cards, side-by-side comparison table, and a guided decision wizard.
...
This site is for educational purposes only and is not legal advice. When in doubt, consult a lawyer.
